...
class UAV2DAvoidSimple1(gym.Env):
    """
    ...
    def reset(self, *, seed=None, options=None):
        ...
        # Initialise Kalman filter from ground truth
    ...
    def _get_obs(self):
        ...
        if self.curriculum_stage >= 3:
            ...
            # ---------- Kalman filter ----------
            self._kf_predict()
            filt_pos, filt_vel = self._kf_update(noisy_pos, noisy_vel)
